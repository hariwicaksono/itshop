    ...
    <v-row justify="center">
        <v-dialog v-model="modalSearch" fullscreen hide-overlay persistent scrollable>
            <v-card>
                ...
                <v-card-text class="py-5" style="height: 100vh;">
                    <v-container>
                        <v-text-field v-model="search" filled class="mt-5 mr-3" label="<?= lang('App.search'); ?>" prepend-inner-icon="mdi-magnify" autofocus="true" :loading="loading3" clearable @click:clear="clearSearch"></v-text-field>

                        <v-btn large @click="searchData" class="mb-5"><v-icon>mdi-magnify</v-icon> Search</v-btn>
